Case of 
	: (Form event code:C388=Sur chargement:K2:1) | (Form event code:C388=-1)
		C_DATE:C307(dateDebutMailOuvert)
		
		dateDebutMailOuvert:=Form:C1466.scenarioDetail.condition.dateDebutMailOuvert
	...
	: (Form event code:C388=Sur données modifiées:K2:15)
		Form:C1466.scenarioDetail.condition.dateDebutMailOuvert:=dateDebutMailOuvert
End case 