Case of 
	: (Form event code:C388=Sur chargement:K2:1) | (Form event code:C388=-1)
		...
		dateDebutMailClique:=Form:C1466.scenarioDetail.condition.dateDebutMailClique
	...
	: (Form event code:C388=Sur données modifiées:K2:15)
		Form:C1466.scenarioDetail.condition.dateDebutMailClique:=dateDebutMailClique
End case 