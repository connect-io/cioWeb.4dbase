...
/*------------------------------------------------------------------------------
Méthode : cwToolUrlEncode

Encodage d'une URL.
https://mozilla.org/?x=шел лы -> https://mozilla.org/?x=%D1%88%D0%B5%D0%BB%20%D0%BB%D1%8B
...
// Déclarations
var $1; $url_t : Text  // URL simple
var $0 : Text  // URL encodé
...
$config_o.onEvent:=Formula:C1597(This:C1470.result:=WA Evaluate JavaScript:C1029(*; This:C1470.area; "encodeURI('"+$url_t+"');"; Is text:K8:3))
