...
If (True:C214)  // Déclarations
	C_LONGINT:C283($1)  // [timestamp] "avant" ou "depuis"
	C_LONGINT:C283($2)  // [timestamp] "jusqu'à"
	C_TEXT:C284($3)  // [texte] type recherche : "0" (Processed) "1" (Queued) "2" (Sent) "3" (Opened) "4" (Clicked) "5" (Bounce) "6" (Spam) "7" (Unsub) "8" (Blocked) "9" (SoftBounce) "10" (HardBounce) "11" (Deferred)
	
	C_TEXT:C284($tsFrom_t;$tsTo_t;$libelleRecherche_t;$resultatHttp_t;$email_t;$demonteChaine_t;$chaineObjet_t)
	C_LONGINT:C283($countMessage_el;$nbBoucle_el;$i_el;$offset_el;$j_el;$contactID_el;$positionCrochet_el;$positionAccolade_el;$positionID_el;$positionVirgule_el;$tsEventAt_el)
	C_OBJECT:C1216($marketingAutomation_cs;$marketingAutomation_o;$mailjet_cs;$mailjet_o;$nbResultat_o;$mailStatut_o;$statut_o;$entitySelection_o;$table_o;$message_o;$messageDetail_o)
