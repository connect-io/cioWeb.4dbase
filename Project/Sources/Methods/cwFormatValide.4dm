...
02/03/22 - Grégory Fromain <gregory@connect-io.fr> - Fix bug sur les dates en 31/XX/XX
------------------------------------------------------------------------------*/
...
$format_o.int:="[+-]?\\d+"  // Entier négatif ou positif
$format_o.real:="[0-9 \\u00a0\\u202f]*,?[0-9]+"
$format_o.real:="(-|\\+)?(([1-9][0-9 \\u00a0\\u202f]*)|(0))(?:(\\.|\\,)[0-9]+)?"  // \u00a0 : Espace insécable, \u202f : Espace fine sécable
$format_o.bool:="(0|1|on|off)"

$format_o.date:="?:(?:31(\\/|-|\\.)(?:0?[13578]|1[02]))\\1|(?:(?:29|30|31)(\\/|-|\\.)(?:0?[13-9]|1[0-2])\\2)(?:(?:1[6-9]|[2-9]\\d)?\\d{2})$|^(?:29(\\/|-|\\.)0?2\\3(?:(?:(?:1[6-9]|[2-9]\\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\\d|2"+"[0\""+"+\"-8])(\\/|-|\\.)(?:(?:0?[1-9])|(?:1[0-2]))\\4(?:(?:1[6-9]|[2-9]\\d)?\\d{2})"
$format_o.date:=""+$format_o.date+"|(00(\\/|-|\\.)00(\\/|-|\\.)(00|0000))"
